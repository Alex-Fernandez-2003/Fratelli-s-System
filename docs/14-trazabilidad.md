...
| `HU-025` | Gestionar y operar turnos                              | `N-009`, `N-011`, `N-014`          | `RF-052`, `RF-053`                               | `RN-020`, `RN-025`, `RN-035`, `RN-036`                               | `RNF-AUD-001`, `RNF-INT-001`                | `docs/puml/flujo-ux-turno-cierre.puml`<br>`docs/10-arquitectura.md` (Turnos / Caja / Cierre)                                 | `cash_sessions`, `shifts`, `shift_assignments`                                                  | `CP-HU025-*` — se define/ejecuta con la HU | Backend implementado; frontend pendiente | 53/53 backend documentado; sin capturas frontend | `IMPLEMENTADO PARCIAL` |
...
El estado actual se deriva exclusivamente de los expedientes de `docs/historias/`, `sprints/sprint-01.md` y el handoff Sprint 2. Diez HU de Sprint 1 poseen implementación documentada; las historias operativas de Sprint 2 conservan evidencia de backend y frontend pendiente cuando su expediente así lo declara.
...
| Implementación Sprint 2 registrada       | **8 expedientes con backend implementado y frontend pendiente** |
| Validación final de Product Owner         | **No declarada: no existe `sprint-01-review.md`** |
