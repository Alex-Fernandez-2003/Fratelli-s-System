...
| `IMPLEMENTADO`  | La funcionalidad existe y superó las verificaciones técnicas previstas.                    |
...
| `HU-009` | Registrar y gestionar pedidos                          | `N-011`                            | `RF-025`, `RF-026`                               | `RN-001`, `RN-003`                                                   | `RNF-CON-003`, `RNF-USA-003`                | `docs/puml/flujo-ux-pedido-venta.puml`<br>`docs/10-arquitectura.md` (Pedidos / KDS / Ventas; SignalR en Cocina)              | `orders`, `order_items`, `shifts`                                                               | `CP-HU009-*` — se define/ejecuta con la HU | `PENDIENTE`    | `PENDIENTE` | `PENDIENTE`         |
| `HU-010` | Generar y gestionar comandas de cocina                 | `N-011`                            | `RF-028`, `RF-029`, `RF-030`                     | `RN-002`, `RN-003`                                                   | `RNF-CON-003`, `RNF-USA-003`                | `docs/puml/flujo-ux-pedido-venta.puml`<br>`docs/10-arquitectura.md` (Pedidos / KDS / Ventas; SignalR en Cocina)              | `orders`, `order_items`, `kitchen_commands`, `kitchen_command_items`                            | `CP-HU010-*` — se define/ejecuta con la HU | `PENDIENTE`    | `PENDIENTE` | `PENDIENTE`         |
| `HU-011` | Cancelar pedido antes de que esté listo                | `N-011`                            | `RF-027`, `RF-029`                               | `RN-003`                                                             | `RNF-CON-003`, `RNF-USA-004`                | `docs/puml/flujo-ux-pedido-venta.puml`<br>`docs/10-arquitectura.md` (Pedidos / KDS / Ventas; SignalR en Cocina)              | `orders`, `order_items`, `kitchen_commands`, `kitchen_command_items`                            | `CP-HU011-*` — se define/ejecuta con la HU | `PENDIENTE`    | `PENDIENTE` | `PENDIENTE`         |
| `HU-012` | Registrar y confirmar una venta                        | `N-004`, `N-011`, `N-014`          | `RF-031`, `RF-032`, `RF-033`, `RF-035`, `RF-036` | `RN-004`, `RN-005`, `RN-008`, `RN-015`                               | `RNF-INT-001`, `RNF-CON-001`, `RNF-AUD-001` | `docs/puml/flujo-ux-pedido-venta.puml`<br>`docs/10-arquitectura.md` (Pedidos / KDS / Ventas; SignalR en Cocina)              | `sales`, `sale_items`, `orders`, `inventory_movements`, `inventory_balances`                    | `CP-HU012-*` — se define/ejecuta con la HU | `PENDIENTE`    | `PENDIENTE` | `PENDIENTE`         |
| `HU-013` | Continuar venta con stock insuficiente                 | `N-004`, `N-005`                   | `RF-020`, `RF-035`, `RF-036`                     | `RN-005`                                                             | `RNF-INT-004`, `RNF-USA-004`                | `docs/puml/flujo-ux-pedido-venta.puml`<br>`docs/10-arquitectura.md` (Pedidos / KDS / Ventas; SignalR en Cocina)              | `sales`, `sale_items`, `orders`, `inventory_movements`, `inventory_balances`                    | `CP-HU013-*` — se define/ejecuta con la HU | `PENDIENTE`    | `PENDIENTE` | `PENDIENTE`         |
...
| `HU-020` | Registrar gastos diarios                               | `N-009`, `N-014`                   | `RF-045`                                         | `RN-017`, `RN-020`, `RN-022`                                         | `RNF-AUD-001`, `RNF-AUD-002`                | `docs/puml/flujo-ux-turno-cierre.puml`<br>`docs/10-arquitectura.md` (Gastos / operación de caja)                             | `expense_categories`, `expenses`, `shifts`                                                      | `CP-HU020-*` — se define/ejecuta con la HU | `PENDIENTE`    | `PENDIENTE` | `PENDIENTE`         |
...
Antes del inicio de los Sprints:

```text
HU-001 ... HU-031
→ especificadas y trazadas
→ implementación PENDIENTE
→ pruebas ejecutadas PENDIENTE
→ evidencia de ejecución PENDIENTE
```

Una HU no pasa a `IMPLEMENTADO` únicamente porque exista código; debe cumplir el gate definido en `13-pruebas-y-validacion.md`.
...
La trazabilidad de diseño se mantiene por dominio para evitar duplicar especificaciones completas en esta matriz.
...
| Implementaciones reales registradas      | **0 — todavía no inició desarrollo**                 |
| Evidencias de implementación registradas | **0 — todavía no inició desarrollo**                 |

Las dos últimas filas no representan una deficiencia: son el estado correcto antes del Sprint 1.
