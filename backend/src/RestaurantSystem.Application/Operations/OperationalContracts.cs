...
public sealed record SaleDto(Guid Id, Guid OrderId, Guid ShiftId, decimal Subtotal, decimal Total, IReadOnlyList<SaleItemDto> Items, SalesChannel SalesChannel, PaymentMethod PaymentMethod, DateTimeOffset ConfirmedAt, string ConfirmedByUserId, string? ConfirmedByDisplayName);
