...
using RestaurantSystem.Infrastructure.Cash;
...
public static class DependencyInjection
{
    public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddScoped<ITokenService, JwtTokenService>(); services.AddScoped<IRefreshTokenService, RefreshTokenService>(); services.AddScoped<IAuthService, AuthService>(); services.AddScoped<ICatalogService, CatalogService>(); services.AddScoped<ISupplierService, SupplierService>(); services.AddSingleton<IBusinessClock, BusinessClock>(); services.AddScoped<AttendanceDerivationService>(); services.AddScoped<IAttendanceService, AttendanceService>(); services.AddScoped<IUserManagementService, UserManagementService>(); services.AddSingleton<IAttendanceNotifier, SignalRAttendanceNotifier>(); services.AddSingleton<IKitchenRealtimeNotifier, SignalRKitchenRealtimeNotifier>(); services.AddScoped<IOrderService, OrderService>(); services.AddScoped<IKitchenCommandService, KitchenCommandService>(); services.AddScoped<InventoryService>(); services.AddScoped<IInventoryService>(sp => sp.GetRequiredService<InventoryService>()); services.AddScoped<IInventoryWriter>(sp => sp.GetRequiredService<InventoryService>()); services.AddScoped<IInventoryAvailability>(sp => sp.GetRequiredService<InventoryService>()); services.AddScoped<IExpenseService, ExpenseService>(); services.AddScoped<ISalesAuthorizationScope, SalesAuthorizationScope>(); services.AddScoped<ICashPositionCalculator, CashPositionCalculator>(); services.AddScoped<IOperationsService, OperationsService>(); services.AddHostedService<DevelopmentDataSeeder>();
        return services;
    }
}