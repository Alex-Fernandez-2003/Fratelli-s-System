...
namespace RestaurantSystem.Infrastructure.Migrations
{
    ...
    [Migration("20260831112909_AddEmployeeHourlyRateAndWorkScheduleSnapshots")]
    partial class AddEmployeeHourlyRateAndWorkScheduleSnapshots
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RestaurantSystem.Domain.Customers.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Ci")
                        .IsUnique()
                        .HasDatabaseName("UX_customers_ci");

                    b.HasIndex("Nit")
                        .IsUnique()
                        .HasDatabaseName("UX_customers_nit_not_null")
            ...
            modelBuilder.Entity("RestaurantSystem.Domain.Operations.Production", b =>
                {
                    ...
                    b.HasIndex("BatchCode")
                        .IsUnique()
                        .HasDatabaseName("UX_productions_batch_code");
                    ...
                    b.ToTable("productions", "public", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_productions_status", "\"Status\" IN ('COMPLETED')");
                        });
                });
            ...
            modelBuilder.Entity("RestaurantSystem.Domain.Operations.Sale", b =>
                {
                    ...
                    b.Property<string>("CustomerCiSnapshot")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
                    ...
                    b.Property<string>("CustomerNitSnapshot")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
            ...
            modelBuilder.Entity("RestaurantSystem.Domain.Operations.Sale", b =>
                {
                    b.HasOne("RestaurantSystem.Domain.Customers.Customer", null)
                        .WithMany()
